		...
		<div id="top-header">
			<div class="container">
				<div class="pull-left">
                        ...
                        <span>Добро пожаловать  в OPTIMUM BEAUTY   :    </span><span></span>
 <span>   :    </span><span></span>";


                 
                        <b>Добро пожаловать Гость</b>
					
				</div>
				<div class="pull-right">
					<ul class="header-top-links">
						
					<button style='width:100px;' background:#800080; border-radius:5px;' class='btn next-btn'><a href='checkout.php' class='text-uppercase' style='color:#fff;'>Войти</a></buuton>";
			
					<button style='width:100px;' background:#800080; border-radius:5px;' class='btn next-btn'><a href='logout.php' class='text-uppercase' style='color:#fff;'>Выити</a></buuton>";
						...
						<li class="header-cart dropdown default-dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
								<div class="header-btns-icon">
									...
									<span class="qty">tottal item</span>
								</div>
								<strong class="text-uppercase">Мой заказы:</strong>
								<br>
								<span>tottal price</span>
							</a>
	...
	<li class="dropdown side-dropdown">
		...
		<div class="custom-menu">
			<div class="row">
				<div class="col-md-4">
					<ul class="list-links">
						<li><h3 class="list-links-title"><a href="" name="allcosm">Косметология</a>  </h3></li>
...
<li style='width:300px;'><a href=''></a></li>";
					...
					<hr class="hidden-md hidden-lg">
													...
													<li><a href="all_products.html">Все продукты</a></li>
												</ul>
											</div>
											<!-- menu nav -->
											<div class="menu-nav">
												...
												<ul class="menu-list">
													...
													<li id="center1" ><a href="../all_products.php" title="живой пойск"></a></li>
												</ul>
											</div>
<!-- menu nav -->
			</div>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					...
					<div class="footer-copyright">
						...
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Designed <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Daniel</a>
						<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					</div>
					<!-- /footer copyright -->
				</div>
